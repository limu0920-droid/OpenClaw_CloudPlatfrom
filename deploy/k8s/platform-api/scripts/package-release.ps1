...
Copy-Item -Path (Join-Path $repoRoot "apps\\server\\internal\\httpapi\\externaldocs\\openapi.yaml") -Destination (Join-Path $docsOut "external-openapi.yaml")
Copy-Item -Path (Join-Path $repoRoot "apps\\server\\internal\\httpapi\\externaldocs\\integration-guide.md") -Destination (Join-Path $docsOut "external-integration-guide.md")
